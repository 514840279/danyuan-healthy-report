...
public class SysMenuInfo {
	...
	public String toString() {
		return "SysMenuInfo [uuid=" + uuid + ", systemId=" + systemId + ", parentsId=" + parentsId + ", name=" + name + ", uri=" + uri + ", icon=" + icon + ", sort=" + sort + ", discription=" + discription + ", insertDatetime=" + insertDatetime + ", insertUser=" + insertUser + ", updateTime=" + updateTime + ", updateUser=" + updateUser + ", deleteFlag=" + deleteFlag + ", type=" + type + ", iconSkin=" + iconSkin + ", checked=" + checked + ", homePage=" + homePage + ", moveType=" + moveType + "]";
	}
