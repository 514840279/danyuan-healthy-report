...
public class ExcelUtil {
	...
	//
	// String src_xlspath = "G:\\车主\\安徽\\安庆市\\安庆--500.xls";
	// String dist_xlsPath = "D:\\1.xls";
	// List<List<Row>> rowList;
	// try {
	 ...
	 * @throws IOException
	 */
	public List<List<Row>> readExcel() throws IOException {
	 ...
	 * @throws IOException
	 */
	public List<List<Row>> readExcel(String xlsPath) throws IOException {
	...
	// * @throws IOException
	// */
	// public List<List<Row>> readExcel_xlsx() throws IOException {
	 ...
	 * @throws Exception
	 */
	public List<List<Row>> readExcel_xlsx(String xlsPath) throws IOException {
		// 判断文件是否存在
		File file = new File(xlsPath);
		if (!file.exists()) {
	...
	// */
	// public List<List<Row>> readExcel_xls() throws IOException {
	 ...
	 * @Date : 2014-9-11 上午09:53:21
	 */
	public List<List<Row>> readExcel_xls(String xlsPath) throws IOException {
	 ...
	 *            换行
	 */
	public void out(String msg, boolean tr) {
		if (printMsg) {
