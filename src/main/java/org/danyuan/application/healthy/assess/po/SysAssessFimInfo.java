...
/**
 * @文件名 SysAssessFimInfo.java
 * @包名 org.danyuan.application.healthy.assess.po
 * @描述 sys_assess_fim_info的实体类
 * @时间 2019年09月24日 17:46:51
 * @author test
 * @版本 V1.0
 */
@Entity
@Table(name = "sys_assess_fim_info")
@NamedQuery(name = "SysAssessFimInfo.findAll", query = "SELECT s FROM SysAssessFimInfo s")
public class SysAssessFimInfo extends BaseEntity implements Serializable {
