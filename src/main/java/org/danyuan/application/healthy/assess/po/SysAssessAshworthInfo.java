...
/**
 * @文件名 SysAssessAshworthInfo.java
 * @包名 org.danyuan.application.healthy.assess.po
 * @描述 sys_assess_ashworth_info的实体类
 * @时间 2019年09月24日 17:46:51
 * @author test
 * @版本 V1.0
 */
@Entity
@Table(name = "sys_assess_ashworth_info")
@NamedQuery(name = "SysAssessAshworthInfo.findAll", query = "SELECT s FROM SysAssessAshworthInfo s")
public class SysAssessAshworthInfo extends BaseEntity implements Serializable {
