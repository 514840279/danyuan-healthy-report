...
/**
 * @文件名 SysUseAssessSuggestionService.java
 ...
 */
@Service
public class SysUseAssessSuggestionService extends BaseServiceImpl<SysUseAssessSuggestion> implements BaseService<SysUseAssessSuggestion> {
