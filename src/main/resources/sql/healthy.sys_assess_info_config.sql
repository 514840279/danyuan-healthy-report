...
-- 菜单配置 
 ...
 INSERT INTO sys_roles_jurisdiction_info(checked, create_time, create_user, delete_flag, discription, menu_id, role_id) VALUES (1,CURRENT_TIMESTAMP, 'system', 0, '生成语句', '14ffad3c9e4749d69f1d4b310ea8a80f', 'BEB0D81B918DD968D24D6F95AC15A753'); 

-- ================sys_assess_info(一般资料)配置结束======================= 
