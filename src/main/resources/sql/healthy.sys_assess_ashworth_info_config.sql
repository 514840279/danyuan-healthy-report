-- ================sys_assess_ashworth_info(Ashworth评级)配置开始======================= 
-- 菜单配置 
 ...
 INSERT INTO sys_roles_jurisdiction_info(checked, create_time, create_user, delete_flag, discription, menu_id, role_id) VALUES (1,CURRENT_TIMESTAMP, 'system', 0, '生成语句', '4f99b47c87504561912e3b968575e070', 'BEB0D81B918DD968D24D6F95AC15A753'); 

-- ================sys_assess_ashworth_info(Ashworth评级)配置结束======================= 
