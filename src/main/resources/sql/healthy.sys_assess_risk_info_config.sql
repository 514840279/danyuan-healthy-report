-- ================sys_assess_risk_info(风险因素评估)配置开始======================= 
-- 菜单配置 
 ...
 INSERT INTO sys_roles_jurisdiction_info(checked, create_time, create_user, delete_flag, discription, menu_id, role_id) VALUES (1,CURRENT_TIMESTAMP, 'system', 0, '生成语句', '60a2ca0afb404e5fabd3bd081dde5ec2', 'BEB0D81B918DD968D24D6F95AC15A753'); 

-- ================sys_assess_risk_info(风险因素评估)配置结束======================= 
